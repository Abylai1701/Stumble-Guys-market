//
//  ConnectionAlertHelperWithReturn.swift
...
class ConnectionAlertHelperWithReturn_e0Q04 {
    static var shared = ConnectionAlertHelperWithReturn_e0Q04()
    ...
    @objc private func viewTapped() {
        // Cancel the scheduled work item as the view is tapped
        hideViewWorkItem?.cancel()
        hide()
    }
